    ...
    var body: some View {
        ZStack{
            ...
            VStack{
               Spacer()
                    IntroduceView(
                        mainTitle: "出品者情報の登録が必要です。",
                        describeText: "ひとこまで、出品するためには口座情報の登録が必要になります。以下の出品ボタンより、アカウントを作成してください。",
                        describeImage: "talk"
                    )
                Spacer()
                Button {
                    ...
                    RichButton(
                        buttonText: "出品",
                        buttonImage: "arrowshape.turn.up.right.fill"
                    )
                    .padding()
                    .shadow(radius: 20, x: 20, y: 20)
                    .shadow(color: .white, radius: 20, x: -10, y: -10)
                }
            }
        }
