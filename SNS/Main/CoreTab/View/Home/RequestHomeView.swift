...
struct RequestHomeView: View {
    ...
    var body: some View {
        ScrollView{
            VStack{
                VStack(spacing: .zero){
                    Image("ramen").resizable().frame(width: UIScreen.main.bounds.width, height: 200)
                    HStack(spacing: .zero){
                        Image("rootImage").resizable().frame(width: UIScreen.main.bounds.width/2, height: 200)
                        Image("header").resizable().frame(width: UIScreen.main.bounds.width/2, height: 200)
                    }
                }
