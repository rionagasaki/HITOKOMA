...
struct AfterLessonView: View {
    ...
    var body: some View {
        VStack(alignment: .leading){
            ...
            Button {
                SetToFirestore().registerEvalutionToLesson(lessonId: "", allEvalution: allSelection, easyToUnderstand: clearitySelection, interesting: interestingSelection, review: thoughtText) {
                    UpdateFirestore().updateLessonCompletionUser(lessonId: "")
                }
            } label: {
